  ...
  const medicos = [
    {
      ...
      infoStudies:
        "Médico especialista en cardiología con más de 10 años de experiencia",
    ...
    },
    {
      ...
      specialty: "Pediatría",
      infoStudies:
        "Médico especialista en pediatría con más de 15 años de experiencia",
      opinions: [
        "Muy buena atención a los niños",
        "Explica muy bien el diagnóstico",
      ],
    ...
    },
    {
      ...
      infoStudies:
        "Médico especialista en dermatología con más de 8 años de experiencia",
      opinions: [
        "Me ayudó a solucionar mi problema de acné",
        "Muy profesional en su trato",
      ],
    ...
    },
    {
      ...
      infoStudies:
        "Médico especialista en oftalmología con más de 12 años de experiencia",
    ...
    },
    {
      ...
      infoStudies:
        "Médico especialista en cirugía general con más de 15 años de experiencia",
      opinions: [
        "Muy profesional en su trabajo",
        "Muy atento con los pacientes",
      ],
    ...
    },
    {
      ...
      infoStudies:
        "Médico especialista en psiquiatría con más de 10 años de experiencia",
      opinions: [
        "Muy empática con los pacientes",
        "Me ha ayudado a superar mi depresión",
      ],
