...
const EditarPacientes = () => {
  const { patients, fetchPatients, fetchPatientByEmail } = useContext(Context)[1];
  ...
  useEffect(() => {
    // filtro para que busque por nombre
      ...
      <Container>
        ...
        >
          <TextField
            ...
            variant="outlined"
            size="small"
            sx={{ backgroundColor: "#009BFF" }} // Cambia el color del campo de la seacbar
            InputProps={{
