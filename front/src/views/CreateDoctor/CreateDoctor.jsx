  ...
  return (
    ...
    >
      <StyleForm component={Paper} elevation={5}
        onSubmit={handleSubmit} style={{ backgroundColor: 'rgba(255, 255, 255)' }}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            ...
            {
                error.fotoMatricula ? (
                  <Typography variant="inherit" color="error" style={{ maxWidth: '180px', fontSize:'12px', margin:'6px' }}>
                    {error.fotoMatricula}
                  </Typography>
                ) : null
                }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              FormHelperTextProps={{ style: {  maxWidth: '200px'} }}sx={{
                height: "90px",
                width: "250px",
              }}
            />
