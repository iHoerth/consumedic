      ...
      <div>
        ...
        >
          ...
          <CardContent>
            ...
            <NavLink to={doctor.linkedin} target="_blank" activeClassName="active">
              <Typography variant="body2" color="text.secondary" sx={{ p: 1 }}>
            ...
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
              ...
              <AccordionDetails>
                <Typography variant="body2" color="text.secondary">
                  {doctor.idioma &&
                    doctor.idioma.map((item, index) => <div key={index}>{item}</div>)}
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
              ...
              <AccordionDetails>
                <Typography variant="body2" color="text.secondary">
                  {doctor.servicios &&
                    doctor.servicios.map((item, index) => <div key={index}>{item}</div>)}
                </Typography>
              </AccordionDetails>
            </Accordion>
