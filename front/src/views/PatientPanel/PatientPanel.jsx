import { Container, Box, Button, IconButton, FormControl, InputLabel, MenuItem, Select, TableHead, TableRow, TableBody, Table, TableCell, Typography} from '@mui/material'
    ...
    >
      ...
      <Container 
        ...
        >
          ...
          <Box m={2} p={3} boxShadow={3} borderRadius={2} backgroundColor= '#c8e6c9' sx={{mb: '20%' }}>
            <h2>Mis turnos</h2>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', mt: '1%', mb: '7%' }}>
              ...
              <Button onClick={() => { setSelectedSpecialty(null); setSelectedDirection(null); }} sx={{ gap: 1.3 }}>
            ...
            <Box>
              <Table>
                ...
                {turnos?.filter(turno => 
                  ...
                  <Box >
                    <Typography variant="subtitle1" sx={{ display: 'flex', justifyContent: 'center', ml: '20%', mb: '10%' }}>
