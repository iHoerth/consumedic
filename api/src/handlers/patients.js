...
const { getSoftDeletedPatient } = require('../controllers/patients/getSoftDeletedPatient');
const { modifyPatientProfile } = require('../controllers/patients/modifyPatientProfile');
...
const postPatient = async (req, res) => {
  let { loggedFromGoogle, dni, email, password, telefono, nombre, apellido, idObraSocial, status } =
    req.body;
  try {
    if (loggedFromGoogle) {
