...
const sendMailDocumento = async (nombreDoctor, apellidoDoctor, emailRecibe, emailEscribe, subjectDocumento, messageDocumento, title) => {
  ...
  let mailMsg = {
    ...
    <body>
      <div class="container">
        ...
        <div class="datos">
            <p class="message">${messageDocumento} "${title}"</p>
        </div>
...
module.exports = { sendMailDocumento };
